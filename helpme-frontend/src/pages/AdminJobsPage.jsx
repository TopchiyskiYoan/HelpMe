...
const s = {
  ...
  select: {
    ...
    fontSize: '13px', background: '#fffbf0', outline: 'none',
  },
...
export default function AdminJobsPage() {
  ...
  return (
    <AdminLayout>
      <div style={s.header}>
        <div style={s.title}>Поръчки</div>
        <select style={s.select} value={status} onChange={handleStatusChange}>
